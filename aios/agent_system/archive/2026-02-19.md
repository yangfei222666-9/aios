...
- PD200X 麦克风已设为系统默认录音设备（set_default_mic.py）
- 珊瑚海计划春节后购买 Insta360 Link 2 Pro (¥1758)

## 明天待办
- [ ] Whisper 切 GPU：装 CUDA 版 PyTorch，升级到 medium/large 模型
- [ ] ClawdHub 重试安装 automation-workflows
