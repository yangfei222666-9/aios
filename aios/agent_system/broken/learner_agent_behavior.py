...
class AgentBehaviorLearner:
    ...
    def run(self) -> Dict:
        ...
        print(f"  收集了 {agent_data['total_agents']} 个 Agent 的数据")
        ...
        print(f"  识别了 {len(tool_analysis.get('effective_combinations', []))} 个有效工具组合")
        ...
        print(f"  识别了 {len(best_practices.get('practices', []))} 个最佳实践")
