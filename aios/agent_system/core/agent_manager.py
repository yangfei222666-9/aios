...
class AgentManager:
    def __init__(self, data_dir: str = None):
        ...
        self.templates_file = Path(__file__).parent.parent / "templates" / "templates.json"
    ...
    def update_stats(self, agent_id: str, success: bool, duration_sec: float):
        ...
        stats['success_rate'] = stats['tasks_completed'] / total_tasks if total_tasks > 0 else 0.0
        
        stats['total_duration_sec'] += duration_sec
        stats['avg_duration_sec'] = stats['total_duration_sec'] / total_tasks if total_tasks > 0 else 0
    ...
    def get_agent_summary(self) -> Dict:
        ...
        total_tasks = sum(a['stats']['tasks_completed'] + a['stats']['tasks_failed'] 
