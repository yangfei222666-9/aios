...
class TaskRouter:
    ...
    def match_agent(self, task_analysis: Dict, available_agents: List[Dict]) -> Optional[str]:
        """
        匹配合适的 Agent
    ...
    def should_create_new(self, task_analysis: Dict, available_agents: List[Dict]) -> Tuple[bool, str]:
        """
        判断是否需要创建新 Agent
